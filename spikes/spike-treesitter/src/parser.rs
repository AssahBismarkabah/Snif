...
use snif_common::{FileExtraction, Import, Language, ParseError, Reference, Symbol};
...
pub fn parse_file(
    ...
    let parse_errors = collect_errors(root, source);
...
fn collect_errors(root: tree_sitter::Node, _source: &[u8]) -> Vec<ParseError> {
